...
public class RectangleDialog extends JDialog {
				...
				.addGroup(gl_contentPanel.createSequentialGroup()
					...
					.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING, false)
						...
						.addGroup(gl_contentPanel.createParallelGroup(Alignment.TRAILING, false)
							.addComponent(textField_b, Alignment.LEADING, 0, 0, Short.MAX_VALUE)
							.addComponent(textField_a, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 59, Short.MAX_VALUE)))
				...
				okButton.addMouseListener(new MouseAdapter() {
					...
					public void mouseClicked(MouseEvent e) {
						try {
							...
							rectangle= new Rectangle(upLeft,Integer.parseInt(getTextField_a().getText()),Integer.parseInt(getTextField_b().getText()),getBtnBorderColor().getBackground(),getBtnInnerColor().getBackground());
							setOk(true);
							setVisible(false);
						} catch (Exception g) {
	...
	public void setTextField_b(JTextField textField_b) {
